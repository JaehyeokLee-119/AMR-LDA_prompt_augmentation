...
def double_negation(graphs, gtos, sentence_list, logic_word_list):
    return_list = []
    negative_list = []
    label_list = []
    sentence_and_tag_list = []
...
if __name__ == '__main__':
    ...
    stog = amrlib.load_stog_model("/hdd/hjl8708/workspace/AMR-LDA/Refactoried/pretrained_models/model_parse_xfm_bart_large-v0_1_0")
    ...
    if flag == "ReClor": #"/hdd/hjl8708/workspace/AMR-LDA/Refactoried/pretrained_models"
        dataframe_ReClor = pd.read_csv("/hdd/hjl8708/workspace/AMR-LDA/Refactoried/extracted_data/ReClor.csv")
        dataframe_list.append(dataframe_ReClor)
    elif flag == "Wikihop":
        dataframe_Wikihop = pd.read_csv("/hdd/hjl8708/workspace/AMR-LDA/Refactoried/extracted_data/Wikihop.csv")
        dataframe_list.append(dataframe_Wikihop)
    elif flag == "Synthetic":
        dataframe_synthetic = pd.read_csv("/hdd/hjl8708/workspace/AMR-LDA/Refactoried/output_result/synthetic_sentences.csv")
        dataframe_list.append(dataframe_synthetic)
        dataframe_synthetic_2 = pd.read_csv("/hdd/hjl8708/workspace/AMR-LDA/Refactoried/output_result/synthetic_single_no_logic_words_sentences.csv")
    ...
    for idx, item in enumerate(dataframe_list_single_sentences):
        ...
        gtos = amrlib.load_gtos_model("/hdd/hjl8708/workspace/AMR-LDA/Refactoried/pretrained_models/model_generate_t5wtense-v0_1_0")
    ...
    for idx, item in enumerate(dataframe_list):
        ...
        df.to_csv("/hdd/hjl8708/AMR-LDA/Refactoried/"+keywords_list[idx]+"_xfm_t5wtense_logical_equivalence_list.csv",index = None,encoding = 'utf8')
